...
cmdDesc MakeDocs = """
  Generates HTML docs for all packages in the given package collection.
...
runCmd = do
  ...
  case cmd of
    ...
    (MakeDocs ** [db])  => finally (rmDir tmpDir) $ idrisEnv mc True >>= makeDocs
